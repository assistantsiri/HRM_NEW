...
namespace DAL
{
    public class SalaryRegisterDA
    {
        ...
        public List<string> GetEmployeeNumbersByBranch(string branchName)
        {
            List<string> employeeNumbers = new List<string>();
            using (SqlConnection connection = new SqlConnection(connStr))
            {
                connection.Open();
                using (SqlCommand cmd = new SqlCommand("GetEmployeesByBranch", connection))
                {
